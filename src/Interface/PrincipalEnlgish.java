 ...
 * @author Lucas Vieira
 */
public class PrincipalEnlgish extends javax.swing.JFrame {

    /**
     * Creates new form Principal
     */
    public PrincipalEnlgish() {
        initComponents();
        jRadioButtonAmostral.setSelected(true);
        setIcon();
        //jComboBox1.addItem("Lucas");
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        if(descriptiveList.isEmpty()){
            JOptionPane.showMessageDialog(null, "ERRO: Empty Table!");
        }else{
            switch (jComboBox1.getSelectedIndex()){
                case 0: 
                    JOptionPane.showMessageDialog(null, "ERRO: Choose an Option!");
                    break;
                case 1:
                    JOptionPane.showMessageDialog(null, "Arithmetic Mean = " +(sumNumberListed(descriptiveList)/descriptiveList.size()));
                    break;
                case 2:
    ...
    private void portugueseButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_portugueseButtonActionPerformed
        Principal portugueseScreen = new Principal();
        portugueseScreen.setVisible(true);
        this.dispose();
    ...
    private void validateNewValue (){
        ...
        if(txtValue.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "ERRO: Insert a Value!");
        }else if(!validateDoubleValue(Double.parseDouble(txtValue.getText()) )){
            JOptionPane.showMessageDialog(null, "ERRO: Negative Value!");
        }else if ( txtFrequency.isEnabled() && txtFrequency.getText().isEmpty() ){
            JOptionPane.showMessageDialog(null, "ERRO: Empty Frequency!");
        }else if ( txtFrequency.isEnabled() && Integer.parseInt(txtFrequency.getText())<=0){
            JOptionPane.showMessageDialog(null, "ERRO: Negative Frequency!");
        }else{
    ...
    public void removeID (int intRemove){
        if ( !validateIntValue(intRemove) ){
            JOptionPane.showMessageDialog(null, "ERRO: Invalid ID!");
            txtRemoveID.setText("");
        }else if ( intRemove-1 >= descriptiveList.size() ){
            JOptionPane.showMessageDialog(null, "ERRO: Nonexistent ID!");
        }else{
    ...
    public void calculateGeometricMean (){
        JOptionPane.showMessageDialog(null, "Geometric Mean = " +geometricMean());
    }
    ...
    public void calculateMediana(ArrayList<DescriptiveNumber> listAux){
        ...
        JOptionPane.showMessageDialog(null, "Median = " +valueMediana);
    }
    ...
    public void calculateAmplitude (ArrayList<DescriptiveNumber> listAux){
        ...
        JOptionPane.showMessageDialog(null, "Range = " +valueAux);
    }
    ...
    public void calculateVariancia (){
        ...
        JOptionPane.showMessageDialog(null, "Variance = " +value);
    }
    ...
    public void desvioPadrao (){
        ...
        aux = Math.sqrt(aux);
        JOptionPane.showMessageDialog(null, "Standard Deviation = " +aux);
    }
    ...
    public void erroPadrao (){
        ...
        JOptionPane.showMessageDialog(null, "Standard Erro = " +aux);
    }
    ...
    public void coefVar (){
        ...
        JOptionPane.showMessageDialog(null, "Coefficient of variation = " +((aux/median)*100) +"%");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrincipalEnlgish.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrincipalEnlgish().setVisible(true);
            }
        });
    }
